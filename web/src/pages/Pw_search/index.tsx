                  ...
                  <div className="tab_content pw">
                    <div className="input_box">
                      <input
                        ...
                        value="0"
                      />
                      <p className="find_tit">휴대폰으로 찾기</p>
                      <span className="txt">
                        가입 당시 입력한 이메일(Email)을 통해 임시 비밀번호를
                        발급 받을 수 있습니다.
                        <br />
                      ...
                      <ul>
                        ...
                        <li className="phone">
                          ...
                          <div className="wrapper">
                            <input
                              type="text"
                              name="MEM_MST_KCB_PHONENO_01"
                              id="MEM_MST_KCB_PHONENO_01"
                              className="text number"
                            />
                            <select
                              className="select_option"
                              name="MEM_MST_KCB_PHONENO_02"
                      ...
                      <span className="info mt30">
                        본인 인증 시 제공되는 정보는 인증 이외의 용도로 이용
                        또는 저장하지 않습니다.
                      </span>
                      <span className="info">
